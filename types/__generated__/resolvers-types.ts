...
export type GetReviewsByDestinationIdQuery = { __typename?: 'Query', getReviewsByDestinationID?: Array<{ __typename?: 'Review', id: string, rating: number, title: string, username: string, text: string }> | null };
...
export type GetReviewByUserIdQuery = { __typename?: 'Query', getReviewsByUserID?: Array<{ __typename?: 'Review', id: string, title: string, text: string, rating: number, destinationid: string, destination: { __typename?: 'Destination', id: string, title: string } }> | null };
...
export type LoginMutation = { __typename?: 'Mutation', login: { __typename?: 'UserData', token: string, user: { __typename?: 'User', id: string, name: string, username: string, image?: string | null } } };
...
export type GetMeQuery = { __typename?: 'Query', getUserByID?: { __typename?: 'User', id: string, name: string, username: string, image?: string | null, reviews?: Array<{ __typename?: 'Review', id: string, title: string, text: string, rating: number, destinationid: string }> | null } | null };
 ...
 * });
 */
export function useGetMeQuery(baseOptions: Apollo.QueryHookOptions<GetMeQuery, GetMeQueryVariables> & ({ variables: GetMeQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
