...
export type MutationResolvers<ContextType = any, ParentType extends ResolversParentTypes['Mutation'] = ResolversParentTypes['Mutation']> = ResolversObject<{
  addFavoriteToUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationAddFavoriteToUserArgs, 'destinationID' | 'userID'>>;
  addReviewToUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationAddReviewToUserArgs, 'reviewID' | 'userID'>>;
  ...
  createUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationCreateUserArgs, 'name' | 'password' | 'username'>>;
  ...
  removeFavoriteFromUser?: Resolver<ResolversTypes['User'], ParentType, ContextType, RequireFields<MutationRemoveFavoriteFromUserArgs, 'destinationID' | 'userID'>>;
...
export type QueryResolvers<ContextType = any, ParentType extends ResolversParentTypes['Query'] = ResolversParentTypes['Query']> = ResolversObject<{
  ...
  getAvailableCategories?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, Partial<QueryGetAvailableCategoriesArgs>>;
  getAvailableCountries?: Resolver<Array<ResolversTypes['String']>, ParentType, ContextType, Partial<QueryGetAvailableCountriesArgs>>;
  ...
  getFavoritesByUserID?: Resolver<Maybe<Array<ResolversTypes['Destination']>>, ParentType, ContextType, RequireFields<QueryGetFavoritesByUserIdArgs, 'id'>>;
  ...
  getReviewsByUserID?: Resolver<Maybe<Array<ResolversTypes['Review']>>, ParentType, ContextType, RequireFields<QueryGetReviewsByUserIdArgs, 'id'>>;
...
export type GetMeQuery = { __typename?: 'Query', me?: { __typename?: 'User', id: string, name: string, username: string, image?: string | null, reviews?: Array<{ __typename?: 'Review', id: string, title: string, text: string, rating: number, username: string, destinationid: string }> | null, favorites?: Array<{ __typename?: 'Destination', id: string, title: string, titlequestion?: string | null, description: string, longdescription: string, categories: Array<string>, country: string, region?: string | null, image: string, alt: string, rating: number }> | null } | null };
...
export type LoginMutation = { __typename?: 'Mutation', login?: { __typename?: 'User', id: string, name: string, username: string, image?: string | null, reviews?: Array<{ __typename?: 'Review', id: string, title: string, text: string, rating: number, destinationid: string }> | null, favorites?: Array<{ __typename?: 'Destination', id: string, title: string, region?: string | null, rating: number, description: string, image: string, alt: string, country: string }> | null } | null };
...
export type GetAllDestinationsQuery = { __typename?: 'Query', getAllDestinations?: { __typename?: 'PaginatedDestinations', totalCount: number, destinations: Array<{ __typename?: 'Destination', id: string, title: string, country: string, region?: string | null, image: string, description: string, rating: number, categories: Array<string> }> } | null };
...
export type GetDestinationsByTextSimilarityQuery = { __typename?: 'Query', getDestinationsByTextSimilarity?: Array<{ __typename?: 'Destination', id: string, title: string, country: string, region?: string | null, image: string, description: string, rating: number, categories: Array<string> } | null> | null };
...
export type GetDestinationByIdQuery = { __typename?: 'Query', getDestination?: { __typename?: 'Destination', id: string, title: string, region?: string | null, rating: number, description: string, longdescription: string, image: string, alt: string, country: string, categories: Array<string> } | null };

export type GetFeaturedDestinationsQueryVariables = Exact<{ [key: string]: never; }>;


export type GetFeaturedDestinationsQuery = { __typename?: 'Query', getFeaturedDestinations?: Array<{ __typename?: 'Destination', id: string, image: string, alt: string, categories: Array<string>, titlequestion?: string | null, country: string } | null> | null };
...
export type CreateReviewMutation = { __typename?: 'Mutation', createReview?: { __typename?: 'Review', id: string, rating: number, title: string, username: string, text: string } | null };
...
export type GetReviewsByDestinationIdQuery = { __typename?: 'Query', getReviewsByDestinationID?: Array<{ __typename?: 'Review', id: string, rating: number, title: string, username: string, user_avatar?: string | null, text: string, image?: string | null }> | null };
...
export type GetReviewByUserIdQuery = { __typename?: 'Query', getReviewsByUserID?: Array<{ __typename?: 'Review', id: string, title: string, text: string, rating: number, destinationid: string }> | null };
...
export type DeleteReviewMutation = { __typename?: 'Mutation', deleteReview?: { __typename?: 'Review', id: string } | null };
...
export type CreateUserMutation = { __typename?: 'Mutation', createUser: { __typename?: 'User', id: string, name: string, username: string, image?: string | null, reviews?: Array<{ __typename?: 'Review', id: string, title: string, text: string, rating: number, destinationid: string }> | null, favorites?: Array<{ __typename?: 'Destination', id: string, title: string, region?: string | null, rating: number, description: string, image: string, alt: string, country: string }> | null } };
...
export type AddReviewToUserMutation = { __typename?: 'Mutation', addReviewToUser: { __typename?: 'User', id: string, name: string, username: string } };
...
export type UpdateUserMutation = { __typename?: 'Mutation', updateUser: { __typename?: 'User', id: string, name: string, username: string, image?: string | null } };
...
export type AddFavoriteToUserMutation = { __typename?: 'Mutation', addFavoriteToUser: { __typename?: 'User', id: string, name: string, username: string } };
...
export type RemoveFavoriteFromUserMutation = { __typename?: 'Mutation', removeFavoriteFromUser: { __typename?: 'User', id: string, name: string, username: string } };
...
export type GetReviewsByUserIdQuery = { __typename?: 'Query', getReviewsByUserID?: Array<{ __typename?: 'Review', id: string, title: string, text: string, rating: number, username: string, destinationid: string }> | null };
...
export type GetFavoritesByUserIdQuery = { __typename?: 'Query', getFavoritesByUserID?: Array<{ __typename?: 'Destination', id: string, title: string, region?: string | null, rating: number, description: string, image: string, alt: string, country: string }> | null };
 ...
 * });
 */
export function useGetAllDestinationsQuery(baseOptions: Apollo.QueryHookOptions<GetAllDestinationsQuery, GetAllDestinationsQueryVariables> & ({ variables: GetAllDestinationsQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAllDestinationsQuery, GetAllDestinationsQueryVariables>(GetAllDestinationsDocument, options);
      }
export function useGetAllDestinationsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAllDestinationsQuery, GetAllDestinationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAllDestinationsQuery, GetAllDestinationsQueryVariables>(GetAllDestinationsDocument, options);
        }
export function useGetAllDestinationsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetAllDestinationsQuery, GetAllDestinationsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAllDestinationsQuery, GetAllDestinationsQueryVariables>(GetAllDestinationsDocument, options);
        }
...
export type GetAllDestinationsQueryResult = Apollo.QueryResult<GetAllDestinationsQuery, GetAllDestinationsQueryVariables>;
 ...
 * });
 */
export function useGetDestinationsByTextSimilarityQuery(baseOptions: Apollo.QueryHookOptions<GetDestinationsByTextSimilarityQuery, GetDestinationsByTextSimilarityQueryVariables> & ({ variables: GetDestinationsByTextSimilarityQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetDestinationsByTextSimilarityQuery, GetDestinationsByTextSimilarityQueryVariables>(GetDestinationsByTextSimilarityDocument, options);
      }
export function useGetDestinationsByTextSimilarityLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetDestinationsByTextSimilarityQuery, GetDestinationsByTextSimilarityQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetDestinationsByTextSimilarityQuery, GetDestinationsByTextSimilarityQueryVariables>(GetDestinationsByTextSimilarityDocument, options);
        }
export function useGetDestinationsByTextSimilaritySuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetDestinationsByTextSimilarityQuery, GetDestinationsByTextSimilarityQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetDestinationsByTextSimilarityQuery, GetDestinationsByTextSimilarityQueryVariables>(GetDestinationsByTextSimilarityDocument, options);
        }
export type GetDestinationsByTextSimilarityQueryHookResult = ReturnType<typeof useGetDestinationsByTextSimilarityQuery>;
export type GetDestinationsByTextSimilarityLazyQueryHookResult = ReturnType<typeof useGetDestinationsByTextSimilarityLazyQuery>;
export type GetDestinationsByTextSimilaritySuspenseQueryHookResult = ReturnType<typeof useGetDestinationsByTextSimilaritySuspenseQuery>;
export type GetDestinationsByTextSimilarityQueryResult = Apollo.QueryResult<GetDestinationsByTextSimilarityQuery, GetDestinationsByTextSimilarityQueryVariables>;
 ...
 * });
 */
export function useGetDestinationByIdQuery(baseOptions: Apollo.QueryHookOptions<GetDestinationByIdQuery, GetDestinationByIdQueryVariables> & ({ variables: GetDestinationByIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetDestinationByIdQuery, GetDestinationByIdQueryVariables>(GetDestinationByIdDocument, options);
      }
export function useGetDestinationByIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetDestinationByIdQuery, GetDestinationByIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetDestinationByIdQuery, GetDestinationByIdQueryVariables>(GetDestinationByIdDocument, options);
        }
export function useGetDestinationByIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetDestinationByIdQuery, GetDestinationByIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetDestinationByIdQuery, GetDestinationByIdQueryVariables>(GetDestinationByIdDocument, options);
        }
...
export type GetDestinationByIdQueryResult = Apollo.QueryResult<GetDestinationByIdQuery, GetDestinationByIdQueryVariables>;
 ...
 * });
 */
export function useGetFeaturedDestinationsQuery(baseOptions?: Apollo.QueryHookOptions<GetFeaturedDestinationsQuery, GetFeaturedDestinationsQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFeaturedDestinationsQuery, GetFeaturedDestinationsQueryVariables>(GetFeaturedDestinationsDocument, options);
      }
export function useGetFeaturedDestinationsLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFeaturedDestinationsQuery, GetFeaturedDestinationsQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFeaturedDestinationsQuery, GetFeaturedDestinationsQueryVariables>(GetFeaturedDestinationsDocument, options);
        }
export function useGetFeaturedDestinationsSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetFeaturedDestinationsQuery, GetFeaturedDestinationsQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetFeaturedDestinationsQuery, GetFeaturedDestinationsQueryVariables>(GetFeaturedDestinationsDocument, options);
        }
...
export type GetFeaturedDestinationsQueryResult = Apollo.QueryResult<GetFeaturedDestinationsQuery, GetFeaturedDestinationsQueryVariables>;
 ...
 * });
 */
export function useGetAvailableCategoriesQuery(baseOptions?: Apollo.QueryHookOptions<GetAvailableCategoriesQuery, GetAvailableCategoriesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetAvailableCategoriesQuery, GetAvailableCategoriesQueryVariables>(GetAvailableCategoriesDocument, options);
      }
export function useGetAvailableCategoriesLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetAvailableCategoriesQuery, GetAvailableCategoriesQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetAvailableCategoriesQuery, GetAvailableCategoriesQueryVariables>(GetAvailableCategoriesDocument, options);
        }
export function useGetAvailableCategoriesSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetAvailableCategoriesQuery, GetAvailableCategoriesQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetAvailableCategoriesQuery, GetAvailableCategoriesQueryVariables>(GetAvailableCategoriesDocument, options);
        }
 ...
 * });
 */
export function useGetAvailableCountriesQuery(baseOptions?: Apollo.QueryHookOptions<GetAvailableCountriesQuery, GetAvailableCountriesQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useGetReviewsByDestinationIdQuery(baseOptions: Apollo.QueryHookOptions<GetReviewsByDestinationIdQuery, GetReviewsByDestinationIdQueryVariables> & ({ variables: GetReviewsByDestinationIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetReviewsByDestinationIdQuery, GetReviewsByDestinationIdQueryVariables>(GetReviewsByDestinationIdDocument, options);
      }
export function useGetReviewsByDestinationIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetReviewsByDestinationIdQuery, GetReviewsByDestinationIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetReviewsByDestinationIdQuery, GetReviewsByDestinationIdQueryVariables>(GetReviewsByDestinationIdDocument, options);
        }
export function useGetReviewsByDestinationIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetReviewsByDestinationIdQuery, GetReviewsByDestinationIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetReviewsByDestinationIdQuery, GetReviewsByDestinationIdQueryVariables>(GetReviewsByDestinationIdDocument, options);
        }
...
export type GetReviewsByDestinationIdSuspenseQueryHookResult = ReturnType<typeof useGetReviewsByDestinationIdSuspenseQuery>;
export type GetReviewsByDestinationIdQueryResult = Apollo.QueryResult<GetReviewsByDestinationIdQuery, GetReviewsByDestinationIdQueryVariables>;
 ...
 * });
 */
export function useGetReviewByUserIdQuery(baseOptions: Apollo.QueryHookOptions<GetReviewByUserIdQuery, GetReviewByUserIdQueryVariables> & ({ variables: GetReviewByUserIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetReviewByUserIdQuery, GetReviewByUserIdQueryVariables>(GetReviewByUserIdDocument, options);
      }
export function useGetReviewByUserIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetReviewByUserIdQuery, GetReviewByUserIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetReviewByUserIdQuery, GetReviewByUserIdQueryVariables>(GetReviewByUserIdDocument, options);
        }
export function useGetReviewByUserIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetReviewByUserIdQuery, GetReviewByUserIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetReviewByUserIdQuery, GetReviewByUserIdQueryVariables>(GetReviewByUserIdDocument, options);
        }
...
export const AddReviewToUserDocument = gql`
  ...
  addReviewToUser(userID: $userID, reviewID: $reviewID) {
    ...
    `;
export type AddReviewToUserMutationFn = Apollo.MutationFunction<AddReviewToUserMutation, AddReviewToUserMutationVariables>;
 ...
 * });
 */
export function useAddReviewToUserMutation(baseOptions?: Apollo.MutationHookOptions<AddReviewToUserMutation, AddReviewToUserMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
...
export type AddReviewToUserMutationOptions = Apollo.BaseMutationOptions<AddReviewToUserMutation, AddReviewToUserMutationVariables>;
...
export const AddFavoriteToUserDocument = gql`
  ...
  addFavoriteToUser(userID: $userID, destinationID: $destinationID) {
    ...
    `;
export type AddFavoriteToUserMutationFn = Apollo.MutationFunction<AddFavoriteToUserMutation, AddFavoriteToUserMutationVariables>;
 ...
 * });
 */
export function useAddFavoriteToUserMutation(baseOptions?: Apollo.MutationHookOptions<AddFavoriteToUserMutation, AddFavoriteToUserMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<AddFavoriteToUserMutation, AddFavoriteToUserMutationVariables>(AddFavoriteToUserDocument, options);
      }
...
export type AddFavoriteToUserMutationOptions = Apollo.BaseMutationOptions<AddFavoriteToUserMutation, AddFavoriteToUserMutationVariables>;
export const RemoveFavoriteFromUserDocument = gql`
  ...
  removeFavoriteFromUser(userID: $userID, destinationID: $destinationID) {
    ...
    `;
export type RemoveFavoriteFromUserMutationFn = Apollo.MutationFunction<RemoveFavoriteFromUserMutation, RemoveFavoriteFromUserMutationVariables>;
 ...
 * });
 */
export function useRemoveFavoriteFromUserMutation(baseOptions?: Apollo.MutationHookOptions<RemoveFavoriteFromUserMutation, RemoveFavoriteFromUserMutationVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useMutation<RemoveFavoriteFromUserMutation, RemoveFavoriteFromUserMutationVariables>(RemoveFavoriteFromUserDocument, options);
      }
...
export type RemoveFavoriteFromUserMutationOptions = Apollo.BaseMutationOptions<RemoveFavoriteFromUserMutation, RemoveFavoriteFromUserMutationVariables>;
...
export function useGetReviewsByUserIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetReviewsByUserIdQuery, GetReviewsByUserIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
 ...
 * });
 */
export function useGetFavoritesByUserIdQuery(baseOptions: Apollo.QueryHookOptions<GetFavoritesByUserIdQuery, GetFavoritesByUserIdQueryVariables> & ({ variables: GetFavoritesByUserIdQueryVariables; skip?: boolean; } | { skip: boolean; }) ) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<GetFavoritesByUserIdQuery, GetFavoritesByUserIdQueryVariables>(GetFavoritesByUserIdDocument, options);
      }
export function useGetFavoritesByUserIdLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<GetFavoritesByUserIdQuery, GetFavoritesByUserIdQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<GetFavoritesByUserIdQuery, GetFavoritesByUserIdQueryVariables>(GetFavoritesByUserIdDocument, options);
        }
export function useGetFavoritesByUserIdSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<GetFavoritesByUserIdQuery, GetFavoritesByUserIdQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}
          return Apollo.useSuspenseQuery<GetFavoritesByUserIdQuery, GetFavoritesByUserIdQueryVariables>(GetFavoritesByUserIdDocument, options);
        }
...
export type GetFavoritesByUserIdQueryResult = Apollo.QueryResult<GetFavoritesByUserIdQuery, GetFavoritesByUserIdQueryVariables>;